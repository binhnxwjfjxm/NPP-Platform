...
export function middleware(request: NextRequest) {
  ...
  // session cookie is enough to enter the local-first shell. Fresh session
  // validation remains at /api/auth/me -> /api/internal-auth/me and at each
  // protected API read/write before fresh data or a mutation is accepted.
