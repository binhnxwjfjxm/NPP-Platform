...
function PrimaryNavItem({ activeSection, item, mobile = false }: { activeSection: AdminSection; item: (typeof primaryNav)[number]; mobile?: boolean }) {
...
export function AdminShell({ activeSection, title, subtitle, children }: {
      ...
      <header className="topbar adminAppTopbar">
        <div className="topbarInner">
          <Link className="brand" href="/" aria-label="Admin MCP/NPP - Tổng quan">
            <span className="brandLogoFrame"><img className="brandLogo" src={appLogoUrl} alt="Logo Hưng Phát Company" /></span>
            <span className="brandCopy">
              <strong className="brandProductName">Admin MCP/NPP</strong>
              <span className="brandDescriptor">Điều hành và quyết định quản trị</span>
          ...
          <details className="appMenu adminAccountMenu">
            ...
            <div className="menuPanel">
              ...
              <Link className="menuItem" href="/menu">
                ...
                <span><strong>Thông tin ứng dụng</strong><small>Cài đặt PWA và phạm vi sử dụng</small></span>
              </Link>
