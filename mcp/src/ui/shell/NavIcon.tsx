...
const paths: Record<NavIconName, JSX.Element> = {
  ...
  mcp: <><path d="M12 3 4.5 7.5v9L12 21l7.5-4.5v-9L12 3Z"/><path d="m4.5 7.5 7.5 4.5 7.5-4.5M12 12v9"/></>,
  route: <><circle cx="6" cy="18" r="2"/><circle cx="18" cy="6" r="2"/><path d="M8 18h2.5a3.5 3.5 0 0 0 0-7H9a3 3 0 0 1 0-6h7"/></>,
  visit: <><path d="M12 21s6-5.2 6-11a6 6 0 1 0-12 0c0 5.8 6 11 6 11Z"/><circle cx="12" cy="10" r="2"/></>,
  ...
  "field-check": <><path d="M4 5h16v14H4z"/><path d="m8 12 2.5 2.5L16 9"/></>,
  task: <><path d="M9 5h11M9 12h11M9 19h11"/><path d="m3 5 1.5 1.5L7 4M3 12l1.5 1.5L7 11M3 19l1.5 1.5L7 18"/></>,
