...
import { patchVariantBarcode, normalizeProductGatewayError, resolveProductRequestId } from '../../../../../../../../lib/product-gateway';
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string; variantId: string; barcodeId: string } }) {
  ...
  try {
    const data = await patchVariantBarcode(params.id, params.variantId, params.barcodeId, requestId, parsed.body);
