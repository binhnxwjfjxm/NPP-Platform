...
export default function PurchasePriceWorkspace() {
  ...
  function openEdit(price: SupplierPurchasePrice) {
    ...
    setDraft({
      ...
      unitId: price.unitId,
      unitPrice: formatDecimalString(price.unitPrice) === '—' ? price.unitPrice : formatDecimalString(price.unitPrice),
      currencyCode: price.currencyCode,
      minQuantity: formatDecimalString(price.minQuantity) === '—' ? price.minQuantity : formatDecimalString(price.minQuantity),
