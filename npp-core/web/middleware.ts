...
export const config = {
  matcher: [
    '/dashboard/:path*', '/management/:path*', '/organization/:path*', '/customers/:path*', '/suppliers/:path*', '/products/:path*', '/pricing/:path*', '/document-numbering/:path*', '/access/:path*', '/inventory/:path*', '/logistics/:path*',
    ...
    '/api/sales-channels/:path*', '/api/price-lists/:path*', '/api/pricing/:path*', '/api/document-number-series/:path*', '/api/inventory/:path*', '/api/logistics/:path*',
  ],
};