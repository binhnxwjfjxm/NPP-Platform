...
export const config = {
  matcher: [
    '/dashboard/:path*', '/organization/:path*', '/customers/:path*', '/suppliers/:path*', '/products/:path*', '/pricing/:path*', '/access/:path*',
    ...
    '/api/sales-channels/:path*', '/api/price-lists/:path*', '/api/pricing/:path*',
  ],
};
