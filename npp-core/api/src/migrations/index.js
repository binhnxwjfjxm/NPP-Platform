...
const PRODUCT_INVENTORY_MANAGEMENT_POLICY_SQL = readFileSync(
  new URL('../../../../database/migrations/shared/091_product_inventory_management_policy.sql', import.meta.url),
  'utf8',
);
...
export const CORE_API_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({ id: '091_product_inventory_management_policy', sql: PRODUCT_INVENTORY_MANAGEMENT_POLICY_SQL }),
]);
