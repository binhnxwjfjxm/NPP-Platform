...
export const CORE_API_MIGRATIONS = Object.freeze([
  ...
  migration('081_sales_fulfillment_shortage_discrepancy', 'sales/081_sales_fulfillment_shortage_discrepancy.sql'),
  migration('082_sales_fulfillment_reversal', ['sales/082_sales_fulfillment_reversal.sql', 'sales/082b_sales_delivery_reversal_hardening.sql', 'logistics/082_logistics_trip_recovery.sql']),
  migration('083_backup_delete_foundation', 'shared/083_backup_delete_foundation.sql'),
  ...
  migration('086_mcp_workforce_permission_catalog', 'shared/086_mcp_workforce_permission_catalog.sql'),
  migration('087_technical_backup_access', 'shared/087_technical_backup_access.sql'),
  ...
  migration('103_sales_order_execution_close_fulfillment', 'sales/103_sales_order_execution_close_fulfillment.sql'),
  migration('104_sales_order_execution_close_partial_release', 'sales/104_sales_order_execution_close_partial_release.sql'),
