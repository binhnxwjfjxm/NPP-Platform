...
const BACKUP_DELETE_FOUNDATION_SQL = readFileSync(
  new URL('../../../../database/migrations/shared/082_backup_delete_foundation.sql', import.meta.url),
  'utf8',
);
...
export const CORE_API_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({ id: '082_backup_delete_foundation', sql: BACKUP_DELETE_FOUNDATION_SQL }),
]);
