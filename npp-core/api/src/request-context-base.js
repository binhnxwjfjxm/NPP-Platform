...
export function createBootstrapPrincipal(config) {
  return normalizePrincipal({
    ...
    permissions: [
      ...
      PERMISSIONS.corePrintTemplateRead,
      PERMISSIONS.corePrintTemplateManage,
      ...
      PERMISSIONS.coreWorkPolicyRead,
      PERMISSIONS.coreWorkPolicyManage,
      PERMISSIONS.coreWorkScheduleRead,
