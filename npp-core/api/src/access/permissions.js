...
const SALES_ORDER_PERMISSION_CATALOG = Object.freeze([
  ...
  ['coreFulfillmentAllocate', 'Phân bổ hàng cho đơn', 'Cho phép phân bổ phần hàng đã giữ vào đúng vị trí và lô trong phạm vi kho được cấp.'],
  ['coreFulfillmentPick', 'Xác nhận soạn hàng', 'Cho phép xác nhận số lượng thực tế đã lấy từ allocation của đơn bán hàng.'],
  ['coreFulfillmentPack', 'Xác nhận đóng gói', 'Cho phép xác nhận số lượng đã đóng gói từ phần đã soạn.'],
  ['coreFulfillmentOverrideAllocationPolicy', 'Đổi thứ tự lô được đề xuất', 'Cho phép phân bổ thủ công khác FEFO/FIFO khi có lý do bắt buộc.'],
].map(([key, label, description]) => Object.freeze({
  permissionKey: PERMISSIONS[key],
  module: key.startsWith('coreFulfillment') ? 'Kho' : 'Bán hàng',
  label,
  description,
  isSystem: true,
})));
