export const PERMISSIONS = Object.freeze({
  ...
  coreInventoryOverrideNegative: 'core.inventory.override-negative',
...
export const PERMISSION_CATALOG = Object.freeze([
  ...
  Object.freeze({ permissionKey: PERMISSIONS.coreInventoryReserve, module: 'Kho', label: 'Quản lý giữ tồn', description: 'Cho phép giữ, giải phóng, tiêu thụ và hết hạn lượng tồn trong phạm vi kho được cấp.', isSystem: true }),
  Object.freeze({ permissionKey: PERMISSIONS.coreInventoryOverrideNegative, module: 'Kho', label: 'Ghi âm kho có kiểm soát', description: 'Quyền dự phòng cho policy âm kho được owner phê duyệt; Phase 4.3 chưa kích hoạt đường override.', isSystem: true }),
